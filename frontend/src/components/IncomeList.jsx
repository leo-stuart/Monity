                    ...
                    {incomes.map((income, index) => (
                        <tr key={income.id} className="border-t border-[#31344d] hover:bg-[#2a2d44] transition-colors">
                            ...
                            <td className="py-2 px-4">
                                <button className="text-red-400 hover:text-red-300 font-semibold transition-colors" onClick={() => handleDelete(income.id)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
