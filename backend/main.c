...
int main(int argc, char *argv[])
{
    ...
    if (argc > 1)
    {
        ...
        else if (strcmp(argv[1], "monthly-history") == 0)
        {
            if (argc != 2)
            {
                printf("Error: Not enough args\n");
        ...
        else if (strcmp(argv[1], "delete-expense") == 0)
        {
            if (argc != 3)
            {
                printf("Error: Not enough args\n");
            ...
            else
            {
                ...
                delete_expense_api(index);
            }
        }
        else if (strcmp(argv[1], "delete-income") == 0)
        {
            if (argc != 3)
            {
                printf("Error: Not enough args\n");
